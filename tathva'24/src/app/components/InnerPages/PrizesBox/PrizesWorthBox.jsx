...
const PrizesWorthBox = ({text,date,venue,neon}) => {
    return (
        <div className="relative flex justify-center items-center xl:mt-[2rem] lg:mt-[1rem] md:mt-[0.8rem] sm:mt-[0.7rem] mt-[0.6rem]">
            ...
            <img src="/left_top.jpeg" alt="idk" className='absolute top-0 left-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6'/>
            <img src="/left_top.jpeg" alt="idk" className='absolute top-0 left-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6'/>
            <img src="/right_top.jpeg" alt="idk" className='absolute top-0 right-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/right_top.jpeg" alt="idk" className='absolute top-0 right-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/right_top.jpeg" alt="idk" className='absolute top-0 right-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/right_top.jpeg" alt="idk" className='absolute top-0 right-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/right_bottom.jpeg" alt="idk" className='absolute  bottom-0 right-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/right_bottom.jpeg" alt="idk" className='absolute  bottom-0 right-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/right_bottom.jpeg" alt="idk" className='absolute  bottom-0 right-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/right_bottom.jpeg" alt="idk" className='absolute  bottom-0 right-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/left_bottom.jpeg" alt="idk" className='absolute  bottom-0 left-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/left_bottom.jpeg" alt="idk" className='absolute  bottom-0 left-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/left_bottom.jpeg" alt="idk" className='absolute  bottom-0 left-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
            <img src="/left_bottom.jpeg" alt="idk" className='absolute  bottom-0 left-0 xl:w-20 xl:h-20 lg:w-10 lg:h-10 md:w-8 md:h-8 w-6 h-6 z-50'/>
