...
const InnerDescription = ({ num, heading, text }) => {
  return (
    <div className="bg-[#ECECEC] w-full max-w-[100%] px-[5%] pb-[5%] rounded-[12px] md:rounded-[30px] lg:rounded-[50px] h-auto md:h-[30vh] lg:h-[20vw] transition-all">
      ...
      {/* Description Section */}
      <div
        className={`relative text-black text-[0.75rem] md:text-[1.5vw] lg:text-[1vw] pt-[2%] ${styles.description}`}
      >
        {text}
