  ...
  return (
    ...
    >
      <div className="flex justify-between">
        <div
          className={`text-black text-[3rem]  leading-[3rem] md:text-[150px] md:leading-[150px] ${styles.heading}`}
        >
          {num}
        </div>
      ...
      <div
        className={`relative text-black text-[9px] md:text-[20px] pt-[2%] ${styles.description}`}
      >
        {text}
